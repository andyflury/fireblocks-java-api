...
import io.fireblocks.client.invoker.auth.ApiKeyAuth;
import io.fireblocks.client.invoker.auth.Authentication;
import io.fireblocks.client.invoker.auth.HttpBearerAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-01-04T16:03:33.446721500+01:00[Europe/Berlin]")@Component("io.fireblocks.client.invoker.ApiClient")
public class ApiClient {
    ...
    public void setApiKey(String apiKey) {
        ...
        for (Authentication auth : authentications.values()) {
            if (auth instanceof ApiKeyAuth) {
                ...
                found = true;
            } else if (auth instanceof HttpBearerAuth) {
                ((HttpBearerAuth) auth).setApiKey(apiKey);
                found = true;
            }
        }
        if (!found) {
    ...
    */
     ...
     * @param headerParams The header parameters
     */
    private void updateParamsForAuth(String path, Object body, String[] authNames, MultiValueMap<String, String> queryParams, HttpHeaders headerParams) {
        for (String authName : authNames) {
            Authentication auth = authentications.get(authName);
            if (auth == null) {
                throw new RestClientException("Authentication undefined: " + authName);
            }
            auth.applyToParams(path, body, queryParams, headerParams);
        }
    }
